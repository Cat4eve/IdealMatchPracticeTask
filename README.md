...
- Non-YOLO models are classifiers, so I had to generate motion boxes, which can be noisy.
- Open-vocabulary labels are sensitive to class wording and context.
- Smaller objects and low-light frames remain challenging for all models.
